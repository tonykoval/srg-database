...
\begin{abstract}
We report the construction of more than half a million previously unrecorded
strongly regular graphs at four feasible parameter sets that are known to be
realised but whose graphs are \emph{not classified}: $\SRG{50,21,8,9}$,
its complement $\SRG{50,28,15,16}$, the self-complementary
$\SRG{49,24,11,12}$, and $\SRG{57,24,11,9}$. The construction is an iterated, ``cascading''
...
\[
  \underbrace{16{,}939}_{\SRG{50,21,8,9}}\ +\
  \underbrace{16{,}939}_{\SRG{50,28,15,16}}\ +\
  \underbrace{{>}379{,}000}_{\SRG{49,24,11,12}}\ +\
  \underbrace{{>}209{,}000}_{\SRG{57,24,11,9}}
\]
distinct, individually verified strongly regular graphs, the counts for
$\SRG{49,24,11,12}$ and $\SRG{57,24,11,9}$ still growing as the cascades run. The methodological heart of the
...
$\SRG{49,24,11,12}$ & $>379{,}000$ & $|\Aut|=1$ on every sample drawn & de~Caen lift \\
$\SRG{57,24,11,9}$  & $>209{,}000$ & $|\Aut|=1$ on every sample drawn & single Sage seed \\
\bottomrule
\end{tabular}
...
round & 1 & 2 & 3 & 4 & 5 & 6 \\
\midrule
new this round & $9$ & $102$ & $829$ & $5{,}408$ & $31{,}409$ & $171{,}607$ \\
cumulative & $9$ & $111$ & $940$ & $6{,}348$ & $37{,}757$ & $209{,}364$ \\
\bottomrule
\end{tabular}
...
\paragraph{Cell size.} We used $m=4$ throughout, natural because the smallest eigenvalue
is $-4$ and size-$4$ cells are abundant. Larger even cells ($m=6,8$) are admissible and
would reach further classes; on the highly symmetric $\SRG{37,18,8,9}$ catalogue, by
contrast, size-$4$, $6$ and $8$ GM switching produced \emph{no} new graph, consistent with
that catalogue being effectively switching-closed and with the saturation we observed for
geometric seeds.
...
larger than the size-$4$ cascade enumerates; and (iii) seeding new unclassified parameters
(e.g.\ other $v<64$ ``$+$'' rows such as $\SRG{49,18,7,6}$ or $\SRG{57,24,11,9}$) from fresh
low-symmetry constructions.
...
strongly regular graphs. We produced more than $600{,}000$ verified graphs across four
parameters --- $\SRG{50,21,8,9}$, its complement $\SRG{50,28,15,16}$,
$\SRG{49,24,11,12}$, and $\SRG{57,24,11,9}$ --- the overwhelming majority asymmetric and
