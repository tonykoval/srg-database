...
OURS = {
    ...
    (49, 24, 11, 12): dict(n=count_lines(os.path.join(WORK, "out/new_srg_49_24_11_12_all.g6")),
                          aut="|Aut|=1 (sampled)", file="out/new_srg_49_24_11_12_all.g6"),
    (57, 24, 11, 9):  dict(n=count_lines(os.path.join(WORK, "out/new_srg_57_24_11_9_all.g6")),
